...
export const Navigation: React.FC<NavigationProps> = ({ carsList, selectedIndex, scrollTo, scrollPrev, scrollNext }: NavigationProps) => { 
    const dimensions = useWindowDimensions();
    const width = typeof dimensions === 'undefined' ? 0 : dimensions.width; 
